...
public class MainFrame extends JFrame {
	...
	public MainFrame() throws LineUnavailableException{	
		...
		about.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ae) {	
				f.setVisible(true);
				if(userInterface.getLanguage().equals("polish"))text = readTextFile("OProgramie");
				else text = readTextFile("About");				
		...
		tips.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ae) {
				f.setVisible(true);
				if(userInterface.getLanguage().equals("polish"))text = readTextFile("TipsTricksPL");
				else text = readTextFile("TipsTricksEN");				
				textArea.setText(text);
			}			
		});
		pro.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ae) {
				f.setVisible(true);
				if(userInterface.getLanguage().equals("polish"))text = readTextFile("ProPL");
				else text = readTextFile("ProEN");				
				textArea.setText(text);
			}			
		});
